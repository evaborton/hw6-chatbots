...
and frustration for users. If the chatbot fails to understand common sense (despite "speaking"
like a human), the user might get frustrated and fail to understand how to correct the chatbot
in a way that it will understand. (For example, repeating the same thing you just said but with
emphasis on different words might help a human understand you, but not a chatbot.)
